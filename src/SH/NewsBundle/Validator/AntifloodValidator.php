<?php
// src/SH/NewsBundle/Validator/AntifloodValidator.php

namespace SH\NewsBundle\Validator;
...
class AntifloodValidator extends ConstraintValidator
{
  ...
  public function validate($value, Constraint $constraint)
  {
    ...
    // On vérifie si cette IP a déjà posté un commentaire il y a moins de 15 secondes
    $isFlood = $this->em
      ->getRepository('SHNewsBundle:Comment')
